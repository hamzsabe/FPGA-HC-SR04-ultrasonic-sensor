...
HD_PWD='C:/Users/hamza/Desktop/HC-SR04_ultrasonic_sensor/HC-SR04_ultrasonic_sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ultrasonic_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ultrasonic_FPGA.tcl -notrace
