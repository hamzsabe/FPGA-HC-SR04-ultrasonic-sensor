...
HD_PWD='C:/Users/hamza/Desktop/HC-SR04_ultrasonic_sensor/HC-SR04_ultrasonic_sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ultrasonic_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ultrasonic_FPGA.tcl
